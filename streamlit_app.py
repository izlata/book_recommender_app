...
with st.sidebar:
    ...
    st.markdown(
        """
        This app provides personalized book recommendations for users 
...
if tab == 'Get recommendations':
    ...
    if user_input_int:
        ...
        # Load the SVD++ model (trained using the Surprise library).
...
if tab == 'About the project':
    ...
    st.markdown(
        ...
        ([GitHub repository](https://github.com/izlata/book_recommender_app))
    ...
    st.markdown(
        """
        The mean rating is about 3.92. Higher ratings are more common. 
    ...
    st.markdown(
        ...
        2. [**Slope One**](https://surprise.readthedocs.io/en/stable/slope_one.html)
            - Test MAE = 0.66
        3. [**SVD++**](https://surprise.readthedocs.io/en/stable/matrix_factorization.html#surprise.prediction_algorithms.matrix_factorization.SVDpp) - **chosen as a final model**
            - Test MAE = 0.63
        ...
        4. [**k-NN Baseline, item-based**](https://surprise.readthedocs.io/en/stable/knn_inspired.html#surprise.prediction_algorithms.knns.KNNBaseline) - the best performance, but very large file
            - Test MAE = 0.60

        ##### The SVD++ model is used in this app to predict unknown ratings for the user. Then the books with the highest predicted ratings are included in the recommendation list.
        """
    )
